"""Small, dependency-free systemd readiness notification adapter."""
...
logger = logging.getLogger("eidolon.systemd")


@dataclass(frozen=True, slots=True)
class SystemdNotifier:
    """Publish lifecycle state without requiring Python systemd bindings."""
    ...
    def stopping(self, status: str = "Bootstrap control plane stopping") -> None:
