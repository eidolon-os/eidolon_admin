...
All mutations go through the same recipe:
    ...
    2. SIGHUP memory-supervisor (which reads the yaml and reconciles agent_runners)
...
from ..schemas import UserCreateRequest, UserDetail, UserMutateResponse
from ..supervisor_hooks import sighup_memory_supervisor, wait_for_user_reachable
from ..users_yaml import UsersYamlError, get_user, set_enabled, upsert_user
