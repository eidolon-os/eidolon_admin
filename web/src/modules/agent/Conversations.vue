...
.obs-item .val { min-width: 0; overflow-wrap: anywhere; word-break: break-word; }
...
.debug-grid .val { font-family: var(--eid-font-mono); overflow-wrap: anywhere; word-break: break-word; }
