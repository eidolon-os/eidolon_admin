...
<template>
  ...
  >
    ...
    <!-- The raw NATS KV viewer is not here. It read the shared blackboard
         through Admin's own database client, which Admin no longer has, and a
         panel that opens onto nothing is worse than a control that is absent.
         The runtime blackboard itself still reaches the cockpit through the
         snapshot; only this raw drill-down is gone. -->
  </main>
</template>
