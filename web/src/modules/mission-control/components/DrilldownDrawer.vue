      ...
      <div class="dw-panel">
        ...
        <template v-else-if="drawerComp">
          ...
          <div class="dw-evidence">
            <!-- The memory evidence lane drew on Admin's memory API and a
                 palace graph that moved to eidolon_memory with the authority.
                 What the snapshot still carries about memory is shown above;
                 the per-recollection evidence is not, and says so rather than
                 rendering an empty lane. -->
            <p class="mc-note">此主机不提供逐条记忆证据</p>
